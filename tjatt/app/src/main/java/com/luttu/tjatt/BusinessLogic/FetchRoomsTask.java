...
public class FetchRoomsTask extends AsyncTask<Void, Void, String> {

    private final String DEBUG_TAG = "FetchRoomTask";
    private TjattModel mModel;

    public FetchRoomsTask(TjattModel model) {
        mModel = model;
    }
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            URL url = new URL("https://" + mModel.getSSLHelper().getServerIP() + ":443/api/roomList");
            ...
            mModel.setRooms(JSONParser.parseRoomList(jsonObject));
